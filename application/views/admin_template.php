    ...
    <body class="<?php echo $body_classes; ?>">
        <div id="wrapper">
            <div id="header">
                ...
                <div class="clear"></div>
                <div class="menu">
                    <a href="<?php echo site_url('admin/about-us') ?>">About Us</a> | 
                    <a href="<?php echo site_url('admin/product') ?>">Products</a> | 
                    <a href="<?php echo site_url('admin/asfour-quality') ?>">Quality</a> | 
                    <a href="<?php echo site_url('admin/worldwide') ?>">Worldwide</a> |                     
                    <a href="<?php echo site_url('admin/faq') ?>">FAQs</a> | 
                    <a href="<?php echo site_url('admin/feedback') ?>">Customer Service</a> | 
                    <a href="<?php echo site_url('admin/contact-us') ?>">Contact Us</a> |
                    <a href="<?php echo site_url('admin/page/showrooms') ?>">showrooms</a> | 
                    <a href="<?php echo site_url('admin/banner') ?>">Banners</a> |
                    <a href="<?php echo site_url('admin/news') ?>">News & Press Releases</a> |
                    <a href="<?php echo site_url('admin/media_center/media_contacts') ?>">Media Contacts</a>
<!--                    <a href="<?php echo site_url('admin/careers') ?>">Careers</a>-->
                </div>
            </div>
